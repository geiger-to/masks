...
ActiveRecord::Schema[7.1].define(version: 2023_12_05_173845) do
  create_table "actor_scopes", force: :cascade do |t|
    t.integer "actor_id"
    t.integer "scope_id"
    t.index ["actor_id"], name: "index_actor_scopes_on_actor_id"
    t.index ["scope_id"], name: "index_actor_scopes_on_scope_id"
  end
