  ...
  class EmailsTest < ActionDispatch::IntegrationTest
    ...
    test "POST /emails sends verification emails" do
      signup_as "admin", password: "password" do
        ...
        email = Masks::Rails::Email.find_by!(email: "test@example.com", actor:)
    ...
    test "POST /emails only one account can verify an email shared with other actors" do
      ...
      new_device do
        ...
        add_email
        email1 = Masks::Rails::Email.find_by!(email: "test@example.com", actor:)
      end
      ...
      new_device do
        ...
        email2 = Masks::Rails::Email.find_by!(email: "test@example.com", actor:)
      end
